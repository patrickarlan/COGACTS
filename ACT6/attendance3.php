      ...
      <div class="container py-3">
        <div class="mx-auto text-center" style="max-width:760px;">
          ...
          <div class="d-flex justify-content-center gap-3 mt-4">
            <button id="favBtn" class="btn btn-outline-primary btn-lg" data-product="attendance3" aria-pressed="false" title="Add to favourites">
              <i class="bi bi-star" id="favIcon"></i> <span class="btn-label">Favourite</span>
            </button>
            <button id="orderBtn" class="btn btn-primary btn-lg" data-product="attendance3">
      ...
      <div class="table-responsive">
        <table class="table table-bordered align-middle">
          <tbody>
            ...
            <!-- GENERAL -->
            <tr class="table-secondary">
              <th colspan="2" class="text-center fw-bold">GENERAL</th>
            </tr>
            <tr>
              <td class="fw-semibold">Voice Prompt</td>
              <td>Yes</td>
            </tr>
            <tr>
              <td class="fw-semibold">Power Supply</td>
              <td>DC 5V/1000mA</td>
            </tr>
            <tr>
            ...
            <tr>
              <td class="fw-semibold">Working Humidity</td>
              <td>5% – 95%</td>
            </tr>
            <tr>
              <td class="fw-semibold">Dimension (W×D×H)</td>
              <td>175 mm × 120 mm × 23 mm</td>
            </tr>
            <tr>
            ...
            <tr>
              <td class="fw-semibold">Working Environment</td>
              <td>Indoor</td>
            </tr>
          </tbody>
        </table>
