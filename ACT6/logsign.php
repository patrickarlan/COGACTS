      ...
      <div class="card login-panel shadow" style="width: 100%;">
            ...
            <form action="logsign.php" method="POST">
              ...
              <div class="d-grid gap-2">
                ...
                <button type="button" class="btn btn-outline-primary w-100" style="padding: 1rem 0; font-size: 1.25rem;" onclick="window.location.href='register.html'">Register</button>
              </div>
          </form>
      </div>
    </div> 
